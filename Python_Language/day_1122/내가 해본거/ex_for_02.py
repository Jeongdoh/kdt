...
#1부터 10000까지 1~10000 정수 범위 만들어주는 함수 range()
bigNums=range(10001) # 0~10000
bugNums=range(1,10001) # 1~10000
...
# 숫자문자열을 정수로 형변환하기------------------------------------------------------
# 원래는 이렇게 바꿨는데
# nums=input('정수 2개를 입력하세요')#['1','3','8','10']
# nums=nums.split(',')
# nums[0]=int(nums[0])
# nums[1]=int(nums[1])
