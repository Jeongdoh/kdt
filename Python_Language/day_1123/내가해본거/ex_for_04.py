...
nums2=[]
for n in nums:
    if not n%2:      # 2로 나눈 나머지 값 0,1 => False, True
        nums2.append(n*3)


nums3=[n*3  for n in nums if not n%2]
#      주고     꺼내고      검사하고(참이면 3으로 값을 준다.)거짓이면 
#     ----/ ----------- /----------
#       3        1           2 결과 True >> 3으로 이동
#                1           2 결과 False >> 1로 이동해서 다음값 확인
print(f'nums2=> {nums2}')
...
# List와 for문 if문  else=========================================================================
#nums의 요소값이 짝수인것은 nums2에 3을 곱해서 넣고 홀수인것은 그래도 리스트에 추가
nums=[1,2,3,4,5,6,7]
nums2=[]
